...
def show_visualisasi():
    ...
    # ---- Chart 1: Revenue per kategori (Horizontal Bar Chart) ----
    ...
    axes[0].set_xlim(0, max(values_rev) * 1.45)
    ...
    axes[2].tick_params(axis="x", rotation=30, colors="white")
